...
public class Professor extends Doctor {
    ...
    public Professor(String name, String id, DegreeLevel degreeLevel, String major, float salary, Department department, ArrayList<String> articles, String certifyingInst) {
